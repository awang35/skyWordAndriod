...
public class SkyWordsActivity  extends BaseGameActivity{
	...
	public static float CAMERA_HEIGHT = 1280;
	...
	// juan - use this method to get access to the current instance of SkyWordsActivity
	public static SkyWordsActivity getSharedInstance()
	{
		return instance; 
	}
